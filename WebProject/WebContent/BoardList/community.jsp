							...
							<li><a
								...
								<div class="depth02_area none">
									<ul class="depth02">
										...
										<li class="last"><a
											href="${pageContext.request.contextPath}/BoardList/citizenOpinionList.jsp">커뮤니티</a></li>
			...
			<div class="menu_loacation">
				<div class="container">
					<a href="${pageContext.request.contextPath}/Main/main.jsp"
						class="home" title="메인페이지로 이동"></a> <span class="depth pointer">커뮤니티</span>
					...
					<div class="board">
						...
						<div class="paging">
							...
							<div id="pagingWeb" class="num" style="display: inline;">
								<a
									href="${pageContext.request.contextPath}/cont?command=community&page=<%=startPage %>"
								...
								%>
								<a
									href="${pageContext.request.contextPath}/cont?command=community&page=<%=nowPage-1 %>"
									onclick="linkPage(1); return false;"><img
									src="${pageContext.request.contextPath}/images/p_prev.gif"
									alt="이전 페이지"></a>
								<%
								...
								%>
								<span><a
									href="${pageContext.request.contextPath}/cont?command=community&page=<%=a %>"
								...
								%>
								<a
									href="${pageContext.request.contextPath}/cont?command=community&page=<%=maxPage %>"
						...
						<c:if test="${not empty sessionScope.sid}">
							<div class="btn" style="text-align: center; display: block">
								...
								<a
									href="${pageContext.request.contextPath}/BoardList/CommunityWrite.jsp">글쓰기</a>
							</div>
						</c:if>
