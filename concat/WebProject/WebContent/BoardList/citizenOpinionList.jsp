				...
				<div class="container">
							...
							<li><a href="#" id="edu002A03이지스에듀" class="btnMainLink"><img
								...
								<div class="depth02_area none">
									<ul class="depth02">
										...
										<li><a href="/30_Menu/DataList/PUB">자료실</a></li>
										<li class="last"><a href="/40_Menu/QnaWrite/PUB">불편해요</a></li>
					...
					<div class="form_area">
						<p class="ver_web">
							...
							| <input type="button" name="WebJoin" value="마이페이지" title="마이페이지"
								class="btnTopMyPage" />
						</p>
		...
		<div id="contents_wrap">
			<div class="menu_loacation">
				<div class="container">
					...
					<span class="depth"><b>공지사항/이벤트</b></span>
				</div>
			</div>
