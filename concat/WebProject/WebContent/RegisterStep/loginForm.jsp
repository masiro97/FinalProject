...
<script type="text/javascript"
	src="https://gc.kis.v2.scr.kaspersky-labs.com/9E773850-0C32-D74E-A93A-09E4CCA19382/main.js"
...
<body>
				...
				<div class="login">
					...
					<form name='loginForm'
						...
						<div class="login_btns" id="loginBtn">
							<input type="submit" class="write" id="submitButton" value="글쓰기"
					...
					<ul class="idpw">
						<li class="srch_id"><a href="/memberRegSelect.do"
	...
	<script type="text/javascript" src="/easy_js/common_spb.js"></script>
	<script type="text/javascript">
		$(function(e) {
			login.initBtn();
			...
			if ($("[name='j_username']").val() == "") {
				...
				if ($("#loginCheck").is(':checked')) {
					...
					if (urlParam["appOsType"] == "android") {
						...
						SetCookie("SPBcookieSaveid", loginForm.memid.value,
								expDate);
						SetCookie("SPBcookieSavepw",
								AES_Encode(loginForm.mempw.value), expDate);
						loginSubmit();
					}
				} else {
					jsonData = {
